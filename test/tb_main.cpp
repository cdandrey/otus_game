...
using Task = std::tuple<otg::PositionProperty::type, otg::AbstractObjectPtr, otg::AbstractCommandPtr>;
...
void runWorker(const std::vector<Task> &tasks)
{
	using namespace otg;
